...
var i_32429 = (0);
while(true){
if((i_32429 < arr.length)){
(arr[i_32429] = null);

var G__32430 = (i_32429 + (1));
i_32429 = G__32430;
continue;
} else {
}
...
var i_32442 = (self__.level + (1));
while(true){
if((i_32442 <= (new_level + (1)))){
(update[i_32442] = self__.header);
...
var i_32444 = (0);
while(true){
if((i_32444 <= self__.level)){
var links_32445 = (update[i_32444]).forward;
if((x__$1 === (((i_32444 < links_32445.length))?(links_32445[i_32444]):null))){
(links_32445[i_32444] = (x__$1.forward[i_32444]));

var G__32446 = (i_32444 + (1));
i_32444 = G__32446;
continue;
} else {
var G__32447 = (i_32444 + (1));
i_32444 = G__32447;
continue;
}
} else {
...
var G__32454 = nx;
var G__32455 = (level__$1 - (1));
x = G__32454;
level__$1 = G__32455;
continue;
} else {
var G__32456 = x;
var G__32457 = (level__$1 - (1));
x = G__32456;
level__$1 = G__32457;
continue;
}
