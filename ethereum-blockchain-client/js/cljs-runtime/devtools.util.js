...
var G__25832 = (i__4790__auto___25831 + (1));
i__4790__auto___25831 = G__25832;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__25697_25836 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__25698_25837 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__25699_25838 = true;
var _STAR_print_fn_STAR__temp_val__25700_25839 = (function (x__4721__auto__){
return sb__4720__auto__.append(x__4721__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__25699_25838);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__25700_25839);

try{var _STAR_print_level_STAR__orig_val__25702_25840 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__25703_25841 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__25703_25841);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__25702_25840);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__25698_25837);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__25697_25836);
}
...
return self__4777__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq25689));
}));
...
var new_formatters = current_formatters.filter((function (p1__25738_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__25738_SHARP_)));
}));
...
var G__25745_25855 = f;
var target__25153__auto___25856 = G__25745_25855;
if(cljs.core.truth_(target__25153__auto___25856)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__25745_25855)].join(''),"\n","target__25153__auto__"].join('')));
}

(target__25153__auto___25856["toString"] = (function (){
...
var G__25746_25857 = "%c%s";
var G__25747_25858 = "color:transparent";
var G__25748_25859 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__25746_25857,G__25747_25858,G__25748_25859) : f.call(null,G__25746_25857,G__25747_25858,G__25748_25859));
...
var G__25863 = (i__4790__auto___25861 + (1));
i__4790__auto___25861 = G__25863;
continue;
} else {
}
break;
...
var vec__25764 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25764,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25764,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__25864__delegate = function (add_fmt,add_args){
...
var G__25864 = function (add_fmt,var_args){
var add_args = null;
...
while (G__25865__i < G__25865__a.length) {G__25865__a[G__25865__i] = arguments[G__25865__i + 1]; ++G__25865__i;}
  add_args = new cljs.core.IndexedSeq(G__25865__a,0,null);
} 
return G__25864__delegate.call(this,add_fmt,add_args);};
G__25864.cljs$lang$maxFixedArity = 1;
G__25864.cljs$lang$applyTo = (function (arglist__25866){
var add_fmt = cljs.core.first(arglist__25866);
var add_args = cljs.core.rest(arglist__25866);
return G__25864__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq25757){
...
var G__25760 = cljs.core.first(seq25757__$2);
var seq25757__$3 = cljs.core.next(seq25757__$2);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25758,G__25759,G__25760,seq25757__$3);
}));
...
var seq__25774 = cljs.core.seq(features);
var chunk__25775 = null;
var count__25776 = (0);
var i__25777 = (0);
while(true){
if((i__25777 < count__25776)){
var feature = chunk__25775.cljs$core$IIndexed$_nth$arity$2(null,i__25777);
...
var G__25913 = seq__25774;
var G__25914 = chunk__25775;
var G__25915 = count__25776;
var G__25916 = (i__25777 + (1));
seq__25774 = G__25913;
chunk__25775 = G__25914;
count__25776 = G__25915;
i__25777 = G__25916;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__25774);
if(temp__5735__auto__){
var seq__25774__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__25774__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__25774__$1);
var G__25918 = cljs.core.chunk_rest(seq__25774__$1);
var G__25919 = c__4609__auto__;
var G__25920 = cljs.core.count(c__4609__auto__);
var G__25921 = (0);
seq__25774 = G__25918;
chunk__25775 = G__25919;
count__25776 = G__25920;
i__25777 = G__25921;
continue;
} else {
var feature = cljs.core.first(seq__25774__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__25922 = cljs.core.next(seq__25774__$1);
var G__25923 = null;
var G__25924 = (0);
var G__25925 = (0);
seq__25774 = G__25922;
chunk__25775 = G__25923;
count__25776 = G__25924;
i__25777 = G__25925;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5733__auto__)){
var o25791 = temp__5733__auto__;
return (o25791["version"]);
} else {
return null;
}
})() == null);
