...
var o25453 = temp__5733__auto__;
var temp__5733__auto____$1 = (o25453["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o25454 = temp__5733__auto____$1;
return (o25454["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__25137__auto__ = f;
return (o__25137__auto__["toString"]).call(o__25137__auto__);
} else {
return "";
}
}catch (e25469){var _ = e25469;
return "";
}});
...
try{var o__25137__auto___25796 = t;
(o__25137__auto___25796["cljs$lang$ctorPrWriter"]).call(o__25137__auto___25796,t,writer);
}catch (e25502){var __25797 = e25502;
}
...
var char_code = (function (){var o__25137__auto__ = (new String(char$));
return (o__25137__auto__["charCodeAt"]).call(o__25137__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__25137__auto__ = String;
return (o__25137__auto__["fromCharCode"]).call(o__25137__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__25544 = num_code;
switch (G__25544) {
case (1):
return (185);
...
var o__25137__auto__ = String;
return (o__25137__auto__["fromCharCode"]).call(o__25137__auto__,superscript_code);
});
/**
...
}catch (e25581){var _e__25158__auto__ = e25581;
return false;
}})())){
...
var vec__25585 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25585,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o25608 = temp__5733__auto__;
var temp__5733__auto____$1 = (o25608["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o25609 = temp__5733__auto____$1;
return (o25609["nameToPath"]);
} else {
return null;
}
} else {
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__25615){
var vec__25616 = p__25615;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25616,(0),null);
...
var G__25814 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__25815 = cljs.core.butlast(remaining_tokens);
name_tokens = G__25814;
remaining_tokens = G__25815;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq25612){
var G__25613 = cljs.core.first(seq25612);
var seq25612__$1 = cljs.core.next(seq25612);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25613,seq25612__$1);
}));
...
var vec__25624 = cljs.core.split_with((function (p1__25623_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__25623_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25624,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25624,(1),null);
...
var vec__25632 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25632,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25632,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__25819 = cljs.core.rest(remaining_tokens);
var G__25820 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__25819;
name_tokens = G__25820;
continue;
} else {
...
var vec__25654 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25654,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25654,(1),null);
var vec__25657 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25657,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25657,(1),null);
var vec__25660 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25660,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25660,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25660,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25660,(3),null);
...
var vec__25678 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25678,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25678,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25678,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25678,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25678,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25678,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__25686 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25686,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25686,(1),null);
var vec__25690 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25690,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25690,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__25704 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__25704) : devtools.munging.parse_fn_info_deep.call(null,G__25704));
})()));
}
} else {
return fn_info;
...
var G__25842 = (arity + (1));
var G__25843 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__25722){
var vec__25723 = p__25722;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25723,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25723,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25729_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__25729_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25730_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__25730_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__25733){
var vec__25734 = p__25733;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25734,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq25731){
var G__25732 = cljs.core.first(seq25731);
var seq25731__$1 = cljs.core.next(seq25731);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25732,seq25731__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25749__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25749__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25749__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25749__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__25750 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25750,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25750,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25750,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25750,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25750,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25750,(5),null);
...
var o__25137__auto__ = f;
return (o__25137__auto__["getBasis"]).call(o__25137__auto__);
});
/**
...
}catch (e25769){var _e__25158__auto__ = e25769;
...
var G__25853 = (obj[cljs.core.first(path)]);
var G__25854 = cljs.core.rest(path);
obj = G__25853;
path = G__25854;
continue;
} else {
...
var _STAR_ = (function (accum,p__25780){
var vec__25782 = p__25780;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25782,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25782,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__25786){
var vec__25787 = p__25786;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25787,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25787,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25787,(2),null);
...
var post_process = (function (p__25792){
var vec__25793 = p__25792;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25793,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__25793,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__25790_SHARP_){
return (obj[cljs.core.first(p1__25790_SHARP_)]);
}),sorted_matches);
