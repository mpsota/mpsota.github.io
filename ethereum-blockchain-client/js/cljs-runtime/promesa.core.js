...
try{var G__28476_28554 = (function (p1__28469_SHARP_){
return promesa.protocols._resolve_BANG_(d,p1__28469_SHARP_);
});
var G__28477_28555 = (function (p1__28470_SHARP_){
return promesa.protocols._reject_BANG_(d,p1__28470_SHARP_);
});
(f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__28476_28554,G__28477_28555) : f.call(null,G__28476_28554,G__28477_28555));
}catch (e28475){var e_28556 = e28475;
promesa.protocols._reject_BANG_(d,e_28556);
}
return d;
}));
...
try{var G__28479 = (function (p1__28471_SHARP_){
return promesa.protocols._resolve_BANG_(d,p1__28471_SHARP_);
});
var G__28480 = (function (p1__28472_SHARP_){
return promesa.protocols._reject_BANG_(d,p1__28472_SHARP_);
});
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__28479,G__28480) : f.call(null,G__28479,G__28480));
...
var len__4789__auto___28563 = arguments.length;
var i__4790__auto___28564 = (0);
while(true){
if((i__4790__auto___28564 < len__4789__auto___28563)){
args_arr__4810__auto__.push((arguments[i__4790__auto___28564]));

var G__28565 = (i__4790__auto___28564 + (1));
i__4790__auto___28564 = G__28565;
continue;
} else {
}
break;
...
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(p1__28491_SHARP_,p2__28492_SHARP_);
}),p,cljs.core.cons(f,fs));
}));

/** @this {Function} */
(promesa.core.chain.cljs$lang$applyTo = (function (seq28494){
...
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28495,G__28496,seq28494__$2);
}));
...
default:
var args_arr__4810__auto__ = [];
var len__4789__auto___28567 = arguments.length;
var i__4790__auto___28568 = (0);
while(true){
if((i__4790__auto___28568 < len__4789__auto___28567)){
args_arr__4810__auto__.push((arguments[i__4790__auto___28568]));

var G__28569 = (i__4790__auto___28568 + (1));
i__4790__auto___28568 = G__28569;
continue;
} else {
}
break;
...
/** @this {Function} */
(promesa.core.chain_SINGLEQUOTE_.cljs$lang$applyTo = (function (seq28499){
...
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28500,G__28501,seq28499__$2);
}));
...
var accept_QMARK_ = ((cljs.core.ifn_QMARK_(pred_or_type))?pred_or_type:(function (p1__28507_SHARP_){
return (p1__28507_SHARP_ instanceof pred_or_type);
}));
...
var accept_QMARK_ = ((cljs.core.ifn_QMARK_(pred_or_type))?pred_or_type:(function (p1__28510_SHARP_){
return (p1__28510_SHARP_ instanceof pred_or_type);
}));
...
var seq__28517 = cljs.core.seq(promises);
var chunk__28518 = null;
var count__28519 = (0);
var i__28520 = (0);
while(true){
if((i__28520 < count__28519)){
var p = chunk__28518.cljs$core$IIndexed$_nth$arity$2(null,i__28520);
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.core.promise.cljs$core$IFn$_invoke$arity$1(p),((function (seq__28517,chunk__28518,count__28519,i__28520,p,state){
return (function (v){
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__28517,chunk__28518,count__28519,i__28520,p,state){
...
});})(seq__28517,chunk__28518,count__28519,i__28520,p,state))
);

return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(v) : resolve.call(null,v));
}
});})(seq__28517,chunk__28518,count__28519,i__28520,p,state))
),((function (seq__28517,chunk__28518,count__28519,i__28520,p,state){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__28517,chunk__28518,count__28519,i__28520,p,state){
return (function (state__$1){
...
var map__28527 = cljs.core.deref(state);
...
var resolved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28527__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28527__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var rejections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28527__$1,new cljs.core.Keyword(null,"rejections","rejections",-1620899911));
...
var G__28529 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("No promises resolved",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rejections","rejections",-1620899911),rejections], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__28529) : reject.call(null,G__28529));
} else {
...
var G__28576 = seq__28517;
var G__28577 = chunk__28518;
var G__28578 = count__28519;
var G__28579 = (i__28520 + (1));
seq__28517 = G__28576;
chunk__28518 = G__28577;
count__28519 = G__28578;
i__28520 = G__28579;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__28517);
if(temp__5735__auto__){
var seq__28517__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__28517__$1)){
var c__4609__auto__ = cljs.core.chunk_first(seq__28517__$1);
var G__28580 = cljs.core.chunk_rest(seq__28517__$1);
var G__28581 = c__4609__auto__;
var G__28582 = cljs.core.count(c__4609__auto__);
var G__28583 = (0);
seq__28517 = G__28580;
chunk__28518 = G__28581;
count__28519 = G__28582;
i__28520 = G__28583;
continue;
} else {
var p = cljs.core.first(seq__28517__$1);
promesa.core.catch$.cljs$core$IFn$_invoke$arity$2(promesa.core.then.cljs$core$IFn$_invoke$arity$2(promesa.core.promise.cljs$core$IFn$_invoke$arity$1(p),((function (seq__28517,chunk__28518,count__28519,i__28520,p,seq__28517__$1,temp__5735__auto__,state){
return (function (v){
if(cljs.core.truth_(new cljs.core.Keyword(null,"resolved","resolved",968763567).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(state)))){
return null;
} else {
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__28517,chunk__28518,count__28519,i__28520,p,seq__28517__$1,temp__5735__auto__,state){
return (function (state__$1){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567),true),new cljs.core.Keyword(null,"counter","counter",804008177),cljs.core.dec);
});})(seq__28517,chunk__28518,count__28519,i__28520,p,seq__28517__$1,temp__5735__auto__,state))
);

return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(v) : resolve.call(null,v));
}
});})(seq__28517,chunk__28518,count__28519,i__28520,p,seq__28517__$1,temp__5735__auto__,state))
),((function (seq__28517,chunk__28518,count__28519,i__28520,p,seq__28517__$1,temp__5735__auto__,state){
return (function (e){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$2(state,((function (seq__28517,chunk__28518,count__28519,i__28520,p,seq__28517__$1,temp__5735__auto__,state){
return (function (state__$1){
return cljs.core.update.cljs$core$IFn$_invoke$arity$4(cljs.core.update.cljs$core$IFn$_invoke$arity$3(state__$1,new cljs.core.Keyword(null,"counter","counter",804008177),cljs.core.dec),new cljs.core.Keyword(null,"rejections","rejections",-1620899911),cljs.core.conj,e);
...
var map__28530 = cljs.core.deref(state);
...
var resolved = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28530__$1,new cljs.core.Keyword(null,"resolved","resolved",968763567));
var counter = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28530__$1,new cljs.core.Keyword(null,"counter","counter",804008177));
var rejections = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28530__$1,new cljs.core.Keyword(null,"rejections","rejections",-1620899911));
if(((cljs.core.not(resolved)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(counter,(0))))){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(default$,new cljs.core.Keyword("promesa.core","default","promesa.core/default",1773193826))){
var G__28532 = cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2("No promises resolved",new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"rejections","rejections",-1620899911),rejections], null));
return (reject.cljs$core$IFn$_invoke$arity$1 ? reject.cljs$core$IFn$_invoke$arity$1(G__28532) : reject.call(null,G__28532));
} else {
return (resolve.cljs$core$IFn$_invoke$arity$1 ? resolve.cljs$core$IFn$_invoke$arity$1(default$) : resolve.call(null,default$));
}
} else {
...
var G__28584 = cljs.core.next(seq__28517__$1);
var G__28585 = null;
var G__28586 = (0);
var G__28587 = (0);
seq__28517 = G__28584;
chunk__28518 = G__28585;
count__28519 = G__28586;
i__28520 = G__28587;
continue;
}
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p1__28533_SHARP_,p2__28534_SHARP_){
return promesa.core.then.cljs$core$IFn$_invoke$arity$2(p1__28533_SHARP_,(function (_){
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p2__28534_SHARP_) : f.call(null,p2__28534_SHARP_));
}));
