...
var len__4789__auto___25962 = arguments.length;
var i__4790__auto___25963 = (0);
while(true){
if((i__4790__auto___25963 < len__4789__auto___25962)){
args__4795__auto__.push((arguments[i__4790__auto___25963]));

var G__25964 = (i__4790__auto___25963 + (1));
i__4790__auto___25963 = G__25964;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq25901){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__25938_SHARP_){
return (!((cljs.core.meta(p1__25938_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25941__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e25947){var _e__25158__auto__ = e25947;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e25949){var _e__25158__auto__ = e25949;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__25953 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__25954 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__25954);

try{var map__25955 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__25955__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__25953);
}});
...
var temp__5733__auto___25974 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___25974)){
var managed_print_level_25975 = temp__5733__auto___25974;
var _STAR_print_level_STAR__orig_val__25960_25976 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__25961_25977 = managed_print_level_25975;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__25961_25977);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__25957_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__25957_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__25960_25976);
}} else {
job_fn();
}
